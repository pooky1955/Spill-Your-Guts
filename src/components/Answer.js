...
class Answer extends React.Component {
    ...
    render(){
        ...
        /* <div width = '100px' backgroundColor = "rgb(255,255,255)"></div> */
            return (
                ...
                <input className = {this.props.identifier}  checked = {this.props.checked} onChange = {this.props.onChange}type = 'checkbox' id = {id} />
                    ...
                    <label htmlFor = {id}>{nameFruit} <span>for {this.props.portion} </span>   </label>
        ...
        return (
            <div style = {myStyle} className = {this.props.identifier}>
                ...
                <label htmlFor ={id}> {nameFruit}  <span className = "Portion">({this.props.portion}) </span> </label> 
            </div>
        )
        }
        }
